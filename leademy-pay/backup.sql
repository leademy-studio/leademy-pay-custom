...
--
-- Host: localhost    Database: ravilfs0_lp
-- ------------------------------------------------------
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2025_07_20_091921_create_cards_table',1),(4,'2025_07_20_091926_create_requests_table',1),(5,'2025_07_20_091928_create_transactions_table',1);
...
CREATE TABLE `transactions` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `transactions_gateway_transaction_id_unique` (`gateway_transaction_id`),
  KEY `transactions_card_id_foreign` (`card_id`),
  CONSTRAINT `transactions_card_id_foreign` FOREIGN KEY (`card_id`) REFERENCES `cards` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-20 18:47:14
